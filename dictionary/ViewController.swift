...
"酒匂はさかは/さかわ）は、大日本帝国海軍の軽巡洋艦。阿賀野型の４番艦。名前は静岡県及び神奈川県を流れる酒匂川から取られている。太平洋戦争中に建造され、巡洋艦として日本で最後に竣工した艦となった。大戦末期の就役で主要な作戦に参加する機会はなく、舞鶴湾で無傷で終戦を迎えた。　　　終戦後は復員船として活躍した。アメリカ軍の原爆実験（クロスフォード作戦）の標的感となり、ビキニ環礁で沈没した。",
