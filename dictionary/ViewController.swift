...
class ViewController: UIViewController, UITableViewDataSource,UITableViewDelegate ,UISearchBarDelegate{
    ...
    var shipImageArray: [UIImage] = [UIImage(named:"艦これ.jpg")!,UIImage(),UIImage(named:"吹雪.jpg")!,UIImage(named:"白雪.jpg")!,UIImage(named:"初雪.jpg")!,UIImage(named:"深雪.jpg")!,UIImage(named:"叢雲.jpg")!,UIImage(named:"東雲.jpg")!,UIImage(named:"薄雲.jpg")!,UIImage(named:"白雲.jpg")!,UIImage(named:"磯波.jpg")!,UIImage(named:"浦波.jpg")!,UIImage(),UIImage(named:"綾波.jpg")!,UIImage(named:"敷波.jpg")!,UIImage(named:"朝霧.jpg")!,UIImage(named:"夕霧.jpg")!,UIImage(named:"天霧.jpg")!,UIImage(named:"狭霧.jpg")!,UIImage(named:"朧.jpg")!,UIImage(named:"曙.jpg")!,UIImage(named:"漣.jpg")!,UIImage(named:"潮.jpg")!,UIImage(),UIImage(named:"暁.jpg")!, UIImage(named:"響.jpg")!,UIImage(named:"雷.jpg")!,UIImage(named:"電.jpg")!,UIImage(),UIImage(named:"球磨.jpg")!,UIImage(named:"多摩.jpg")!,UIImage(named:"北上.jpg")!,UIImage(named:"大井.jpg")!,UIImage(named:"木曽.jpg")!,UIImage(),UIImage(named:"金剛.jpg")!,UIImage(named:"比叡.jpg")!,UIImage(named:"榛名.jpg")!,UIImage(named:"霧島.jpg")!,]
    
    var shipName: [String] = ["艦これ","特Ⅰ型駆逐艦","吹雪","白雪","初雪","深雪","叢雲","東雲","薄雲","白雲","磯波","浦波","特II型駆逐艦","綾波","敷波","朝霧","夕霧","天霧","狭霧","朧","曙","漣","潮","特Ⅲ型駆逐艦","暁","響","雷","電","球磨型軽巡洋艦","球磨","多摩","北上","大井","木曽","金剛型巡洋戦艦","金剛","比叡","榛名","霧島",]
