...
class Shipdata: NSObject {
    ...
    "特III型駆逐艦",
            ...
            "響（ひびき）は、日本海軍の駆逐艦。吹雪型（特型）の22番艦（III型の2番艦）である。この名を持つ日本海軍の艦船としては神風型駆逐艦 (初代)「響」に続いて2隻目。太平洋戦争で戦火により3度の甚大な損傷を蒙ったにもかかわらず沈没せず、終戦まで生き残った強運ぶりと活躍から「不沈艦」、「不死鳥」、「戦争を生きのびる運命の艦」などと形容された。",
    ...
    "球磨型軽巡洋艦",
            ...
            "阿賀野型軽巡洋艦",
            "阿賀野（あがの）は、大日本帝国海軍の軽巡洋艦。阿賀野型軽巡洋艦（阿賀野型二等巡洋艦）の１番艦。艦名は新潟県と福島県を流れる阿賀野川からちなんで命名された。",
            "",
            "",
            "",
